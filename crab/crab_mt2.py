...
config.Data.splitting = 'FileBased' if options.doMC else 'LumiBased'#'EventAwareLumiBased'
config.Data.unitsPerJob = 5 if options.doMC else 1000 # 1000000 # 1M events per job, 115 M in period B of MET pd
